...
@section('content')
    <div class="bg-white rounded-lg shadow-md p-6 dark:bg-gray-800"> {{-- dark mode background --}}
        ...
        <form>
            ...
            <div class="mb-4">
                <label for="device_name" class="block text-gray-700 text-sm font-bold mb-2 dark:text-gray-300">Device
                    Name</label> {{-- dark mode text --}}
            ...
            <div class="mb-4">
                <label for="device_type" class="block text-gray-700 text-sm font-bold mb-2 dark:text-gray-300">Device
                    Type</label> {{-- dark mode text --}}
            ...
            <div class="mb-4">
                <label for="template" class="block text-gray-700 text-sm font-bold mb-2 dark:text-gray-300">Assign Template
                    (Optional)</label> {{-- dark mode text --}}
            ...
            <div class="mb-6">
                <label for="description"
                    class="block text-gray-700 text-sm font-bold mb-2 dark:text-gray-300">Description</label>
                {{-- dark mode text --}}
            ...
            <div class="flex items-center justify-between">
                <button type="submit"
                    class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline dark:bg-blue-700 dark:hover:bg-blue-800 dark:text-white">Add
                    Device</button> {{-- dark mode button --}}
